...
DJANGO_APPS = [
    ...
    "django.contrib.sites",  # Django comes optional sites framework, hook for associating obj and functionality to particular websites  and its a holding place for the domain name and the verbose names of you Django powered sites
]
...
""" Authentication jwt cookie setup """
...
""" End of authentication jwt cook setup """
